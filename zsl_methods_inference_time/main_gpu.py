...
def write_to_csv(avg_time, std_time, methods, features_dim):
    ...
    with open('/home/cristiano.patricio/condor_jobs/Experiments/models_eval/results_methods.csv',
              mode='w') as data_file:
        header = ['Method', '512', '1024', '1056', '1280', '1920', '2048', '4032']
        ...
        for i in range(6):
            ...
            # 4032
            avg_4032 = f"{'-'}" if avg_time[features_dim[6]][i] == '-' else f"{float(avg_time[features_dim[6]][i]):.3f}"
            std_4032 = f"{'-'}" if std_time[features_dim[6]][i] == '-' else f"{float(std_time[features_dim[6]][i]):.3f}"
...
class Eval():
    ...
    def DEM(self):
        ...
        saver.restore(sess, "/home/cristiano.patricio/condor_jobs/Experiments/models_eval/model_dem_" + str(
            self.feat_dim) + "/model.ckpt")
    ...
    def fCLSWGAN(self):
        ...
        # Load keras model
        model = load_model(
            "/home/cristiano.patricio/condor_jobs/Experiments/models_eval/models_f-CLSWGAN/f-CLSWGAN_" + str(
                self.feat_dim) + ".h5")
...
if __name__ == '__main__':
    ...
    features_dim = [512, 1024, 1056, 1280, 1920, 2048, 4032]
